...
public class Email {
    ...
    public Email(String serializedEmail) {
        HashMap<String,String> fieldMap = EmailUtils.getPairMap(serializedEmail, FIELD_DELIM, FIELD_SEPARATOR);
    ...
    public String toString() {
        return TO_FIELD + FIELD_SEPARATOR + to + FIELD_DELIM +
                FROM_FIELD + FIELD_SEPARATOR + from + FIELD_DELIM +
                BODY_FIELD + FIELD_SEPARATOR + body;
    }
}

...
public class InterServer {
  ...
  public static synchronized void streamToStorage(TcpStream clientStream, long sizeInBytes)
      throws IOException {
    clientStream.pipeTcpStreams(storageStream, sizeInBytes);
  }

  public static synchronized void streamToClient(TcpStream clientStream, long sizeInBytes)
      throws IOException {

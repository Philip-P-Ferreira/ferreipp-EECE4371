...
public class ServerThread implements Runnable {
  ...
  public void run() {
    ...
    try {
        ...
        HashMap<String, String> argMap = createProtocolMap(serverStream.read(), PAIR_DELIM, PAIR_SEPARATOR);
  ...
  private static void logUserOut(final HashMap<String,String> argMap, TcpStream stream) throws IOException {
  ...
  private static void sendEmail(final HashMap<String,String> argMap, TcpStream stream) throws IOException {
  ...
  private static void fetchEmails(final HashMap<String,String> argMap, TcpStream stream) throws IOException {
